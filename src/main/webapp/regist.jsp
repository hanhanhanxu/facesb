...
<html>
<head>
    <title>注册-人脸识别.hx</title>
    <script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
</head>
<body>

<br>
<h1 style="text-align: center">注册人脸</h1>
...
<script>
    ...
    document.getElementById("sc").addEventListener("click", function () {
        ...
        $.post('${pageContext.request.contextPath}/regist.action',{'sj':data,'userinfo':userinfo},function(data){
            if(data=="SUCCESS"){
                alert("注册成功，点击刷脸登录。");
                window.location.href = "${pageContext.request.contextPath}/login.jsp";
            } else{
                alert("注册人脸失败！请重试。错误原因:" + data)
